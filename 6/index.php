...
if (isset($_GET['soal'])) {
	if ($_SESSION['ctftechstart'] == 'ctftechmulai' AND empty($_SESSION['ctftech_level6'])) {
		echo '
		<!DOCTYPE html>
		<html>
		<head>
		...
		<div class="form">
			<div class="parent" onclick="">
				<div class="child bg-one" title="Level 6 - CTF Technology">
				</div>
			</div>
			<h1>Logic of Technology - Soal 6</h1>
			...
			<a href="../6/"><button type="submit">Kembali</button></a>
		</div>
		</body>
		</html>';
		...
		echo '
		<script type="text/javascript">
			alert("Anda sudah menyelesaikan soal level 6");
			window.location.href = "../7/";
		</script>';
	}
} else {
	if ($_SESSION['ctftech_level6'] == 'CTFTECH{E4sy_f0r_h4tm1}') {
		echo '
		<script type="text/javascript">
			alert("Anda sudah menyelesaikan CTF Tech Level 6");
			window.location.href = "../7/";
		</script>
		';
	} elseif (empty($_SESSION['ctftechstart'])) {
		...
		if (isset($_POST['heangsubmit'])) {
			...
			if ($heang == 'CTFTECH{E4sy_f0r_h4tm1}') {
				$_SESSION['ctftech_level6'] = $heang;
				echo '
				<script type="text/javascript">
					alert("Selamat anda telah menyelesaikan CTF Tech Level 6");
					window.location.href = "../7/";
				</script>
				';
			} else {
			...
			<body>
			<div class="form">
				<a href="?soal" title="Baca Soal !"><h1>CTF Tech - Level 6</h1></a>
				<form action="" method="post">
					Input your Flag : <input type="text" name="heangflag" placeholder="CTFTECH{y0ur_fl49}">
					<input type="submit" name="heangsubmit" value="Submit">
				</form>
